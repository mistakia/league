...
const format_play = (play) => ({
  ...
  trick_play: format_boolean(play.is_trick_play) || null,
  out_of_pocket_pass: format_boolean(play.is_qb_out_of_pocket) || null,
  int_worthy: format_boolean(play.is_interception_worthy) || null,
  throw_away: format_boolean(play.is_throw_away) || null,
  read_thrown: format_read_thrown(play.read_thrown) || null,
  catchable_ball: format_boolean(play.is_catchable_ball) || null,
  contested_ball: format_boolean(play.is_contested_ball) || null,
  created_reception: format_boolean(play.is_created_reception) || null,
  dropped_pass: format_boolean(play.is_drop) || null,
  qb_sneak: format_boolean(play.is_qb_sneak) || null,
  blitzers: format_number(play.n_blitzers) || null,
  pass_rushers: format_number(play.n_pass_rushers) || null,
  qb_fault_sack: format_boolean(play.is_qb_fault_sack) || null
})
