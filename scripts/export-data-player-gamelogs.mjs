...
enable_debug_namespaces('export-data-player-gamelogs')
...
const format_gamelog = (gamelog) => ({
  ...
  tm: gamelog.nfl_team,
  pos: gamelog.player_position,
  jnum: gamelog.jersey_number,
  active: gamelog.is_active,
  started: gamelog.is_starter,
