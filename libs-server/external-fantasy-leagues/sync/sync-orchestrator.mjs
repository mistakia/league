...
import CbsAdapter from '#libs-server/external-fantasy-leagues/adapters/cbs.mjs'
import FfpcAdapter from '#libs-server/external-fantasy-leagues/adapters/ffpc.mjs'
import NffcAdapter from '#libs-server/external-fantasy-leagues/adapters/nffc.mjs'
import FantraxAdapter from '#libs-server/external-fantasy-leagues/adapters/fantrax.mjs'
import FleaflickerAdapter from '#libs-server/external-fantasy-leagues/adapters/fleaflicker.mjs'
import NflAdapter from '#libs-server/external-fantasy-leagues/adapters/nfl.mjs'
import RtsportsAdapter from '#libs-server/external-fantasy-leagues/adapters/rtsports.mjs'
