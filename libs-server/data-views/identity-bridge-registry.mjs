...
import player_year_week_to_player_year_week_line from './identity-bridges/player-year-week-to-player-year-week-line.mjs'
...
const bridge_modules = [
  ...
  player_year_week_to_player_year_week_line,
