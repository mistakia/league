...
export const AGENT_INSTRUCTIONS = [
  ...
  '',
  'A run has a wall-clock deadline of about fifteen minutes, and an answer delivered after it is discarded whether or not it was right. Almost all of that time is model time, not tool time — every tool call returns in under two seconds, so the cost of a run is the number of turns you take, not the number of tools you call within them.',
  '',
