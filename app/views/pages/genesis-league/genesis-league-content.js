// Copy and link targets for the Genesis League pitch page, kept apart from the
// markup so a change of fact or of contact route is a one-line edit rather than
// a JSX edit. The league facts (team count, format, founding year, season
// number) come from the shared copy module, which is the single source.
//
// This page is the LEAGUE's front door. The site's front door is the landing
// page at `/`, which speaks for the platform and links here as one of the
// things the platform runs.
