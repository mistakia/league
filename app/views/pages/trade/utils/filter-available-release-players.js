 ...
 * @param {object[]} params.all_available_players - All players available for release
 ...
 * @returns {object[]} Filtered array of players that can be released to resolve roster limits
 */
