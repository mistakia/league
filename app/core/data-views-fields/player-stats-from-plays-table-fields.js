...
export default {
  player_pass_yards_from_plays: offensive_player_from_play_field({
    column_title: 'Passing Yards (By Play)',
    column_groups: [COLUMN_GROUPS.PASSING],
    header_label: 'YDS',
    player_value_path: 'pass_yds_from_plays'
  }),
  player_pass_attempts_from_plays: offensive_player_from_play_field({
    column_title: 'Passing Attempts (By Play)',
    column_groups: [COLUMN_GROUPS.PASSING],
    header_label: 'ATT',
    player_value_path: 'pass_atts_from_plays'
  }),
  player_pass_touchdowns_from_plays: offensive_player_from_play_field({
    column_title: 'Passing Touchdowns (By Play)',
    column_groups: [COLUMN_GROUPS.PASSING],
    header_label: 'TD',
    player_value_path: 'pass_tds_from_plays'
  }),
  player_pass_interceptions_from_plays: offensive_player_from_play_field({
  ...
  player_completion_percentage_over_expected_from_plays:
    offensive_player_from_play_field({
      column_title: 'Passing Completion Percentage Over Expected (By Play)',
      column_groups: [COLUMN_GROUPS.PASSING, COLUMN_GROUPS.EFFICIENCY],
      header_label: 'CPOE',
  ...
  player_rush_yards_from_plays: offensive_player_from_play_field({
    column_title: 'Rushing Yards (By Play)',
    column_groups: [COLUMN_GROUPS.RUSHING],
    header_label: 'YDS',
    player_value_path: 'rush_yds_from_plays'
  }),
  player_rush_touchdowns_from_plays: offensive_player_from_play_field({
    column_title: 'Rushing Touchdowns (By Play)',
    column_groups: [COLUMN_GROUPS.RUSHING],
    header_label: 'TD',
    player_value_path: 'rush_tds_from_plays'
  }),
  player_rush_yds_per_attempt_from_plays: offensive_player_from_play_field({
  ...
  player_rush_attempts_from_plays: offensive_player_from_play_field({
  ...
  player_positive_rush_attempts_from_plays: offensive_player_from_play_field({
    column_title: 'Positive Yardage Rush Attempts (By Play)',
    column_groups: [COLUMN_GROUPS.RUSHING],
    header_label: 'POS',
    player_value_path: 'positive_rush_atts_from_plays'
  }),
  player_rush_yards_after_contact_from_plays: offensive_player_from_play_field({
  ...
  player_rush_attempts_share_from_plays: offensive_player_from_play_field({
  ...
  player_rush_yards_share_from_plays: offensive_player_from_play_field({
  ...
  player_rush_first_down_share_from_plays: offensive_player_from_play_field({
  ...
  player_opportunity_share_from_plays: offensive_player_from_play_field({
  ...
  player_fumbles_from_plays: offensive_player_from_play_field({
  ...
  player_broken_tackles_from_plays: offensive_player_from_play_field({
  ...
  player_receptions_from_plays: offensive_player_from_play_field({
    column_title: 'Receptions (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'REC',
    player_value_path: 'recs_from_plays'
  }),
  player_receiving_yards_from_plays: offensive_player_from_play_field({
    column_title: 'Receiving Yards (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'YDS',
    player_value_path: 'rec_yds_from_plays'
  }),
  player_receiving_touchdowns_from_plays: offensive_player_from_play_field({
    column_title: 'Receiving Touchdowns (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'TD',
    player_value_path: 'rec_tds_from_plays'
  }),
  player_drops_from_plays: offensive_player_from_play_field({
  ...
  player_targets_from_plays: offensive_player_from_play_field({
    column_title: 'Targets (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'TGT',
    player_value_path: 'trg_from_plays'
  }),
  player_deep_targets_from_plays: offensive_player_from_play_field({
    column_title: 'Deep Targets (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'DEEP',
    player_value_path: 'deep_trg_from_plays'
  }),
  player_deep_targets_percentage_from_plays: offensive_player_from_play_field({
  ...
  player_air_yards_per_target_from_plays: offensive_player_from_play_field({
  ...
  player_air_yards_from_plays: offensive_player_from_play_field({
    column_title: 'Air Yards (By Play)',
    column_groups: [COLUMN_GROUPS.RECEIVING],
    header_label: 'AY',
    player_value_path: 'air_yds_from_plays'
  }),
  player_receiving_first_down_from_plays: offensive_player_from_play_field({
  ...
  player_air_yards_share_from_plays: offensive_player_from_play_field({
  ...
  player_target_share_from_plays: offensive_player_from_play_field({
  ...
  player_solo_tackles_from_plays: defensive_player_from_play_field({
    column_title: 'Solo Tackles (By Play)',
    column_groups: [COLUMN_GROUPS.TACKLES],
    header_label: 'SOLO',
    player_value_path: 'solo_tackles_from_plays'
  }),
  player_tackle_assists_from_plays: defensive_player_from_play_field({
    column_title: 'Tackle Assists (By Play)',
    column_groups: [COLUMN_GROUPS.TACKLES],
    header_label: 'AST',
    player_value_path: 'tackle_assists_from_plays'
  }),
  player_combined_tackles_from_plays: defensive_player_from_play_field({
