...
export const default_players_table_views = {
  SEASON_PROJECTIONS: {
    ...
    view_description: constants.season.isOffseason
      ? 'Season Projections'
      : 'Rest of Season Projections',
    view_filters: ['player_position', 'player_league_roster_status'],
    view_search_column_id: 'player_name',
    table_state: {
      sort: [
        {
          id: constants.season.isOffseason
  ...
  PASSING_STATS_BY_PLAY: {
    ...
    table_state: {
      sort: [
        {
          id: 'player_pass_yards_from_plays',
          desc: true
        }
      ],
      prefix_columns: ['player_name', 'player_league_roster_status'],
  ...
  RUSHING_STATS_BY_PLAY: {
    ...
    table_state: {
      sort: [
        {
          id: 'player_rush_yards_from_plays',
          desc: true
        }
      ],
      prefix_columns: ['player_name', 'player_league_roster_status'],
  ...
  RECEIVING_STATS_BY_PLAY: {
    ...
    table_state: {
      sort: [
        {
          id: 'player_receiving_yards_from_plays',
          desc: true
        }
      ],
      prefix_columns: ['player_name', 'player_league_roster_status'],
