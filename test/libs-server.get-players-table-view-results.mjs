...
describe('LIBS SERVER get_players_table_view_results', () => {
  ...
  it('should create a query with an N+1 range column', () => {
    ...
    const expected_query = `with "t249d0930a5f2895a157f67f946ee0c94" as (select "trg_pid", "nfl_plays"."year", SUM(CASE WHEN comp = true THEN recv_yds ELSE 0 END) as rec_yds_from_plays_0 from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' group by "trg_pid", "nfl_plays"."year"), "tb2744abfbebebffd07826b653ac939bc" as (select "bc_pid", "nfl_plays"."year", SUM(rush_yds) as rush_yds_from_plays_0 from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' group by "bc_pid", "nfl_plays"."year") select "player"."pid", player.fname, player.lname, "player"."pos" AS "pos_0", "t8a4a84e735183537b2ba13726efd3e32"."points_per_game" AS "points_per_game_from_seasonlogs_0", "t249d0930a5f2895a157f67f946ee0c94"."rec_yds_from_plays_0" as "rec_yds_from_plays_0", "tb2744abfbebebffd07826b653ac939bc"."rush_yds_from_plays_0" as "rush_yds_from_plays_0", COALESCE(t8a4a84e735183537b2ba13726efd3e32.year, t249d0930a5f2895a157f67f946ee0c94.year, tb2744abfbebebffd07826b653ac939bc.year) AS year, "player"."pos" from "player" left join "scoring_format_player_seasonlogs" as "t8a4a84e735183537b2ba13726efd3e32" on "t8a4a84e735183537b2ba13726efd3e32"."pid" = "player"."pid" and t8a4a84e735183537b2ba13726efd3e32.scoring_format_hash = '0df3e49bb29d3dbbeb7e9479b9e77f2688c0521df4e147cd9035f042680ba13d' and t8a4a84e735183537b2ba13726efd3e32.year IN (2023,2022,2021,2020,2019,2018,2017) left join "t249d0930a5f2895a157f67f946ee0c94" on "t249d0930a5f2895a157f67f946ee0c94"."trg_pid" = "player"."pid" and t249d0930a5f2895a157f67f946ee0c94.year = t8a4a84e735183537b2ba13726efd3e32.year + 1 left join "tb2744abfbebebffd07826b653ac939bc" on "tb2744abfbebebffd07826b653ac939bc"."bc_pid" = "player"."pid" and tb2744abfbebebffd07826b653ac939bc.year = t249d0930a5f2895a157f67f946ee0c94.year + 1 where player.pos IN ('WR') group by player.fname, player.lname, "player"."pos", "t8a4a84e735183537b2ba13726efd3e32"."points_per_game", "t249d0930a5f2895a157f67f946ee0c94"."rec_yds_from_plays_0", "tb2744abfbebebffd07826b653ac939bc"."rush_yds_from_plays_0", COALESCE(t8a4a84e735183537b2ba13726efd3e32.year, t249d0930a5f2895a157f67f946ee0c94.year, tb2744abfbebebffd07826b653ac939bc.year), "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 5 DESC NULLS LAST limit 500`
    expect(query.toString()).to.equal(expected_query)
  })
