...
describe('LIBS SERVER get_data_view_results', () => {
  ...
  it('should generate a query with a team stat column', () => {
    ...
    const expected_query = `with "t57303c049413002b904f2ae5f68271e8" as (select "pg"."pid", ROUND(100.0 * COUNT(CASE WHEN nfl_plays.trg_pid = pg.pid THEN 1 ELSE NULL END) / NULLIF(SUM(CASE WHEN trg_pid IS NOT NULL THEN 1 ELSE 0 END), 0), 2) as trg_share_from_plays from "nfl_plays" inner join "player_gamelogs" as "pg" on "nfl_plays"."esbid" = "pg"."esbid" and "nfl_plays"."off" = "pg"."tm" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and ("trg_pid" is not null) and "nfl_plays"."year" in (2023) group by "pg"."pid"), "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(pass_yds) AS team_pass_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_pass_yds_from_plays) as team_pass_yds_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", player.fname, player.lname, "t57303c049413002b904f2ae5f68271e8"."trg_share_from_plays" AS "trg_share_from_plays_0", "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_yds_from_plays" AS "team_pass_yds_from_plays_0", "player"."pos" from "player" left join "t57303c049413002b904f2ae5f68271e8" on "t57303c049413002b904f2ae5f68271e8"."pid" = "player"."pid" left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by player.fname, player.lname, "t57303c049413002b904f2ae5f68271e8"."trg_share_from_plays", "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_yds_from_plays", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(one_week)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
  ...
  it('should create a rushing yards split by week', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2020,2021,2022,2023]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "player_years_weeks" as (SELECT player_years.pid, nfl_year_week_timestamp.year, nfl_year_week_timestamp.week FROM player_years INNER JOIN nfl_year_week_timestamp ON player_years.year = nfl_year_week_timestamp.year), "t223afe0ce18594c3ea3afe8fc9c21a14" as (select COALESCE(bc_pid) as pid, "nfl_plays"."week", "nfl_plays"."year", SUM(rush_yds) as rush_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023) group by "nfl_plays"."week", "nfl_plays"."year", COALESCE(bc_pid)), "ta5bf0e859b7b923c8e371a327e011437" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(rush_yds) AS team_rush_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "ta5bf0e859b7b923c8e371a327e011437_team_stats" as (select "ta5bf0e859b7b923c8e371a327e011437"."nfl_team", sum(ta5bf0e859b7b923c8e371a327e011437.team_rush_yds_from_plays) as team_rush_yds_from_plays, "ta5bf0e859b7b923c8e371a327e011437"."year", "ta5bf0e859b7b923c8e371a327e011437"."week" from "ta5bf0e859b7b923c8e371a327e011437" where "ta5bf0e859b7b923c8e371a327e011437"."year" in (2020, 2021, 2022, 2023) group by "ta5bf0e859b7b923c8e371a327e011437"."nfl_team", "ta5bf0e859b7b923c8e371a327e011437"."year", "ta5bf0e859b7b923c8e371a327e011437"."week") select "player"."pid", player.fname, player.lname, "t223afe0ce18594c3ea3afe8fc9c21a14"."rush_yds_from_plays" AS "rush_yds_from_plays_0", "tf0b1e8f00d3f5ec618c9b50a239c6c22"."ry" AS "week_projected_rush_yds_0", "ta5bf0e859b7b923c8e371a327e011437_team_stats"."team_rush_yds_from_plays" AS "team_rush_yds_from_plays_0", "player_years"."year", COALESCE(t223afe0ce18594c3ea3afe8fc9c21a14.week, tf0b1e8f00d3f5ec618c9b50a239c6c22.week, ta5bf0e859b7b923c8e371a327e011437_team_stats.week) AS week, "player"."pos" from "player_years_weeks" inner join "player" on "player"."pid" = "player_years_weeks"."pid" inner join "player_years" on "player_years"."pid" = "player"."pid" and "player_years"."year" = "player_years_weeks"."year" left join "t223afe0ce18594c3ea3afe8fc9c21a14" on "t223afe0ce18594c3ea3afe8fc9c21a14"."pid" = "player"."pid" and t223afe0ce18594c3ea3afe8fc9c21a14.year = player_years_weeks.year and t223afe0ce18594c3ea3afe8fc9c21a14.year IN (2020,2021,2022,2023) and t223afe0ce18594c3ea3afe8fc9c21a14.week = player_years_weeks.week left join "projections_index" as "tf0b1e8f00d3f5ec618c9b50a239c6c22" on "tf0b1e8f00d3f5ec618c9b50a239c6c22"."pid" = "player"."pid" and tf0b1e8f00d3f5ec618c9b50a239c6c22.year = player_years_weeks.year and tf0b1e8f00d3f5ec618c9b50a239c6c22.year IN (2020,2021,2022,2023) and tf0b1e8f00d3f5ec618c9b50a239c6c22.week = player_years_weeks.week and "tf0b1e8f00d3f5ec618c9b50a239c6c22"."sourceid" = 18 left join "ta5bf0e859b7b923c8e371a327e011437_team_stats" on "ta5bf0e859b7b923c8e371a327e011437_team_stats"."nfl_team" = "player"."current_nfl_team" and ta5bf0e859b7b923c8e371a327e011437_team_stats.year = player_years_weeks.year and ta5bf0e859b7b923c8e371a327e011437_team_stats.year IN (2020,2021,2022,2023) and ta5bf0e859b7b923c8e371a327e011437_team_stats.week = player_years_weeks.week group by player.fname, player.lname, "t223afe0ce18594c3ea3afe8fc9c21a14"."rush_yds_from_plays", "tf0b1e8f00d3f5ec618c9b50a239c6c22"."ry", "ta5bf0e859b7b923c8e371a327e011437_team_stats"."team_rush_yds_from_plays", "player_years"."year", COALESCE(t223afe0ce18594c3ea3afe8fc9c21a14.week, tf0b1e8f00d3f5ec618c9b50a239c6c22.week, ta5bf0e859b7b923c8e371a327e011437_team_stats.week), "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(one_week)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
  ...
  it('keeptradecut and fantasy points from plays with year and week split', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "player_years_weeks" as (SELECT player_years.pid, nfl_year_week_timestamp.year, nfl_year_week_timestamp.week FROM player_years INNER JOIN nfl_year_week_timestamp ON player_years.year = nfl_year_week_timestamp.year), "tc0f50807fc7a7b7169ee7514de1fda43" as (select fantasy_points_plays.pid, ROUND(SUM(CASE WHEN pid_type = 'trg' AND comp = true THEN 1 ELSE 0 END + CASE WHEN pid_type IN ('bc', 'trg') THEN COALESCE(rush_yds, 0) + COALESCE(recv_yds, 0) ELSE 0 END * 0.1 + CASE WHEN pid_type = 'psr' THEN COALESCE(pass_yds, 0) ELSE 0 END * 0.04 + CASE WHEN pid_type = 'bc' AND rush_td = true THEN 6 WHEN pid_type = 'trg' AND pass_td = true THEN 6 WHEN pid_type = 'psr' AND pass_td = true THEN 4 ELSE 0 END + CASE WHEN pid_type = 'psr' AND int = true THEN -1 ELSE 0 END + CASE WHEN pid_type = 'fuml' THEN -1 ELSE 0 END), 2) as fantasy_points_from_plays, "fantasy_points_plays"."week", "fantasy_points_plays"."year" from (select bc_pid as pid, 'bc' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year, week from "nfl_plays" where "bc_pid" is not null union all select psr_pid as pid, 'psr' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year, week from "nfl_plays" where "psr_pid" is not null union all select trg_pid as pid, 'trg' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year, week from "nfl_plays" where "trg_pid" is not null union all select player_fuml_pid as pid, 'fuml' as pid_type, NULL as rush_yds, NULL as recv_yds, NULL as rush_td, NULL as td, NULL as comp, NULL as int, NULL as pass_yds, NULL as pass_td, play_type, seas_type, year, week from "nfl_plays" where "player_fuml_pid" is not null) as "fantasy_points_plays" where not "play_type" = 'NOPL' and "fantasy_points_plays"."seas_type" = 'REG' group by "fantasy_points_plays"."week", "fantasy_points_plays"."year", "fantasy_points_plays"."pid") select "player"."pid", player.fname, player.lname, "tf2c4b095a714eac7d86ea8780f70ad1a"."v" AS "player_keeptradecut_value_0", "tc0f50807fc7a7b7169ee7514de1fda43"."fantasy_points_from_plays" AS "fantasy_points_from_plays_0", CASE WHEN player.dob IS NULL OR player.dob = '0000-00-00' THEN NULL ELSE ROUND(EXTRACT(YEAR FROM AGE(opening_days.opening_day, TO_DATE(player.dob, 'YYYY-MM-DD'))) + (EXTRACT(MONTH FROM AGE(opening_days.opening_day, TO_DATE(player.dob, 'YYYY-MM-DD'))) / 12.0) + (EXTRACT(DAY FROM AGE(opening_days.opening_day, TO_DATE(player.dob, 'YYYY-MM-DD'))) / 365.25), 2) END as age_0, "player_years"."year", COALESCE(nfl_year_week_timestamp.week, tc0f50807fc7a7b7169ee7514de1fda43.week) AS week, "player"."pos" from "player_years_weeks" inner join "player" on "player"."pid" = "player_years_weeks"."pid" inner join "player_years" on "player_years"."pid" = "player"."pid" and "player_years"."year" = "player_years_weeks"."year" left join "opening_days" on "opening_days"."year" = "player_years"."year" left join "nfl_year_week_timestamp" on "nfl_year_week_timestamp"."year" = "player_years_weeks"."year" and "nfl_year_week_timestamp"."week" = "player_years_weeks"."week" inner join "keeptradecut_rankings" as "tf2c4b095a714eac7d86ea8780f70ad1a" on "tf2c4b095a714eac7d86ea8780f70ad1a"."pid" = "player"."pid" and "tf2c4b095a714eac7d86ea8780f70ad1a"."qb" = 2 and "tf2c4b095a714eac7d86ea8780f70ad1a"."type" = 1 and "tf2c4b095a714eac7d86ea8780f70ad1a"."d" = "nfl_year_week_timestamp"."week_timestamp" left join "tc0f50807fc7a7b7169ee7514de1fda43" on "tc0f50807fc7a7b7169ee7514de1fda43"."pid" = "player"."pid" and tc0f50807fc7a7b7169ee7514de1fda43.year = player_years_weeks.year and tc0f50807fc7a7b7169ee7514de1fda43.week = player_years_weeks.week where player.pos IN ('WR') group by player.fname, player.lname, "tf2c4b095a714eac7d86ea8780f70ad1a"."v", "tc0f50807fc7a7b7169ee7514de1fda43"."fantasy_points_from_plays", player.dob, opening_days.opening_day, "player_years"."year", COALESCE(nfl_year_week_timestamp.week, tc0f50807fc7a7b7169ee7514de1fda43.week), "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(six_hours)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
  ...
  it('team pass attempts from plays using dst', () => {
    ...
    const expected_query = `with "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(CASE WHEN psr_pid IS NOT NULL AND (sk IS NULL OR sk = false) THEN 1 ELSE 0 END) AS team_pass_att_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_pass_att_from_plays) as team_pass_att_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", player.fname, player.lname, CASE WHEN rosters_players.slot = 13 THEN 'injured_reserve' WHEN rosters_players.slot = 12 THEN 'practice_squad' WHEN rosters_players.slot IS NULL THEN 'free_agent' ELSE 'active_roster' END AS player_league_roster_status, rosters_players.slot, rosters_players.tid, rosters_players.tag, "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_att_from_plays" AS "team_pass_att_from_plays_0", "player"."pos" from "player" left join "rosters_players" on "rosters_players"."pid" = "player"."pid" and "rosters_players"."year" = ${constants.season.year} and "rosters_players"."week" = ${constants.season.week} and "rosters_players"."lid" = 1 left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" where player.pos IN ('DST') group by player.fname, player.lname, rosters_players.slot, rosters_players.tid, rosters_players.tag, "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_att_from_plays", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 8 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(twelve_hours)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
  ...
  it('single year_offset with rate_type', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2020,2021,2022,2023,2024]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "t586c8b9b6bf4a42a3143b8e2162eabbc" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2020, 2021, 2022, 2023) group by "nfl_games"."year", "player_gamelogs"."pid"), "t0be753947ae8001f7b12c1e04f585bac" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2020, 2021, 2022, 2023, 2024) group by "nfl_games"."year", "player_gamelogs"."pid"), "t01f2c2a7ab158240bb0c9e5bd8b6f248" as (select COALESCE(bc_pid, trg_pid) as pid, "nfl_plays"."year", ROUND(SUM(CASE WHEN nfl_plays.ydl_100 <= 20 AND bc_pid IS NOT NULL THEN 1.30 WHEN nfl_plays.ydl_100 <= 20 AND trg_pid IS NOT NULL THEN 2.25 WHEN nfl_plays.ydl_100 > 20 AND bc_pid IS NOT NULL THEN 0.48 WHEN nfl_plays.ydl_100 > 20 AND trg_pid IS NOT NULL THEN 1.43 ELSE 0 END), 2) as weighted_opportunity_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023) group by "nfl_plays"."year", COALESCE(bc_pid, trg_pid)), "tdb9449e277dd7acfa7becffc6837de2d" as (select fantasy_points_plays.pid, ROUND(SUM(CASE WHEN pid_type = 'trg' AND comp = true THEN 1 ELSE 0 END + CASE WHEN pid_type IN ('bc', 'trg') THEN COALESCE(rush_yds, 0) + COALESCE(recv_yds, 0) ELSE 0 END * 0.1 + CASE WHEN pid_type = 'psr' THEN COALESCE(pass_yds, 0) ELSE 0 END * 0.04 + CASE WHEN pid_type = 'bc' AND rush_td = true THEN 6 WHEN pid_type = 'trg' AND pass_td = true THEN 6 WHEN pid_type = 'psr' AND pass_td = true THEN 4 ELSE 0 END + CASE WHEN pid_type = 'psr' AND int = true THEN -1 ELSE 0 END + CASE WHEN pid_type = 'fuml' THEN -1 ELSE 0 END), 2) as fantasy_points_from_plays, "fantasy_points_plays"."year" from (select bc_pid as pid, 'bc' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "bc_pid" is not null union all select psr_pid as pid, 'psr' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "psr_pid" is not null union all select trg_pid as pid, 'trg' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "trg_pid" is not null union all select player_fuml_pid as pid, 'fuml' as pid_type, NULL as rush_yds, NULL as recv_yds, NULL as rush_td, NULL as td, NULL as comp, NULL as int, NULL as pass_yds, NULL as pass_td, play_type, seas_type, year from "nfl_plays" where "player_fuml_pid" is not null) as "fantasy_points_plays" where not "play_type" = 'NOPL' and "fantasy_points_plays"."seas_type" = 'REG' and "fantasy_points_plays"."year" in (2020, 2021, 2022, 2023) group by "fantasy_points_plays"."year", "fantasy_points_plays"."pid"), "t3be086b09900f234abe240b87af2a599" as (select COALESCE(bc_pid, trg_pid) as pid, "nfl_plays"."year", ROUND(SUM(CASE WHEN nfl_plays.ydl_100 <= 20 AND bc_pid IS NOT NULL THEN 1.30 WHEN nfl_plays.ydl_100 <= 20 AND trg_pid IS NOT NULL THEN 2.25 WHEN nfl_plays.ydl_100 > 20 AND bc_pid IS NOT NULL THEN 0.48 WHEN nfl_plays.ydl_100 > 20 AND trg_pid IS NOT NULL THEN 1.43 ELSE 0 END), 2) as weighted_opportunity_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023, 2024) group by "nfl_plays"."year", COALESCE(bc_pid, trg_pid)), "t5eab6573d0b9be8987373d4cc8d0e985" as (select fantasy_points_plays.pid, ROUND(SUM(CASE WHEN pid_type = 'trg' AND comp = true THEN 1 ELSE 0 END + CASE WHEN pid_type IN ('bc', 'trg') THEN COALESCE(rush_yds, 0) + COALESCE(recv_yds, 0) ELSE 0 END * 0.1 + CASE WHEN pid_type = 'psr' THEN COALESCE(pass_yds, 0) ELSE 0 END * 0.04 + CASE WHEN pid_type = 'bc' AND rush_td = true THEN 6 WHEN pid_type = 'trg' AND pass_td = true THEN 6 WHEN pid_type = 'psr' AND pass_td = true THEN 4 ELSE 0 END + CASE WHEN pid_type = 'psr' AND int = true THEN -1 ELSE 0 END + CASE WHEN pid_type = 'fuml' THEN -1 ELSE 0 END), 2) as fantasy_points_from_plays, "fantasy_points_plays"."year" from (select bc_pid as pid, 'bc' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "bc_pid" is not null union all select psr_pid as pid, 'psr' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "psr_pid" is not null union all select trg_pid as pid, 'trg' as pid_type, rush_yds, recv_yds, rush_td, td, comp, int, pass_yds, pass_td, play_type, seas_type, year from "nfl_plays" where "trg_pid" is not null union all select player_fuml_pid as pid, 'fuml' as pid_type, NULL as rush_yds, NULL as recv_yds, NULL as rush_td, NULL as td, NULL as comp, NULL as int, NULL as pass_yds, NULL as pass_td, play_type, seas_type, year from "nfl_plays" where "player_fuml_pid" is not null) as "fantasy_points_plays" where not "play_type" = 'NOPL' and "fantasy_points_plays"."seas_type" = 'REG' and "fantasy_points_plays"."year" in (2020, 2021, 2022, 2023, 2024) group by "fantasy_points_plays"."year", "fantasy_points_plays"."pid") select "player"."pid", player.fname, player.lname, CASE WHEN rosters_players.slot = 13 THEN 'injured_reserve' WHEN rosters_players.slot = 12 THEN 'practice_squad' WHEN rosters_players.slot IS NULL THEN 'free_agent' ELSE 'active_roster' END AS player_league_roster_status, rosters_players.slot, rosters_players.tid, rosters_players.tag, "t759e866ebe92b4ae46ecd539fdd67a4f"."v" AS "player_keeptradecut_value_0", CAST(t01f2c2a7ab158240bb0c9e5bd8b6f248.weighted_opportunity_from_plays AS DECIMAL) / NULLIF(CAST(t586c8b9b6bf4a42a3143b8e2162eabbc.rate_type_total_count AS DECIMAL), 0) AS "weighted_opportunity_from_plays_0", CAST(tdb9449e277dd7acfa7becffc6837de2d.fantasy_points_from_plays AS DECIMAL) / NULLIF(CAST(t586c8b9b6bf4a42a3143b8e2162eabbc.rate_type_total_count AS DECIMAL), 0) AS "fantasy_points_from_plays_0", CAST(t3be086b09900f234abe240b87af2a599.weighted_opportunity_from_plays AS DECIMAL) / NULLIF(CAST(t0be753947ae8001f7b12c1e04f585bac.rate_type_total_count AS DECIMAL), 0) AS "weighted_opportunity_from_plays_1", CAST(t5eab6573d0b9be8987373d4cc8d0e985.fantasy_points_from_plays AS DECIMAL) / NULLIF(CAST(t0be753947ae8001f7b12c1e04f585bac.rate_type_total_count AS DECIMAL), 0) AS "fantasy_points_from_plays_1", "player_years"."year", "player"."pos" from "player_years" inner join "player" on "player"."pid" = "player_years"."pid" left join "t586c8b9b6bf4a42a3143b8e2162eabbc" on "t586c8b9b6bf4a42a3143b8e2162eabbc"."pid" = "player"."pid" and "t586c8b9b6bf4a42a3143b8e2162eabbc"."year" = "player_years"."year" left join "t0be753947ae8001f7b12c1e04f585bac" on "t0be753947ae8001f7b12c1e04f585bac"."pid" = "player"."pid" and t0be753947ae8001f7b12c1e04f585bac.year = player_years.year + 1 left join "rosters_players" on "rosters_players"."pid" = "player"."pid" and "rosters_players"."year" = ${constants.season.year} and "rosters_players"."week" = ${constants.season.week} and "rosters_players"."lid" = 1 left join "opening_days" on "opening_days"."year" = "player_years"."year" left join "keeptradecut_rankings" as "t759e866ebe92b4ae46ecd539fdd67a4f" on "t759e866ebe92b4ae46ecd539fdd67a4f"."pid" = "player"."pid" and "t759e866ebe92b4ae46ecd539fdd67a4f"."qb" = 2 and "t759e866ebe92b4ae46ecd539fdd67a4f"."type" = 1 and "t759e866ebe92b4ae46ecd539fdd67a4f"."d" = EXTRACT(EPOCH FROM (date_trunc('day', opening_days.opening_day) + interval '0 year'))::integer and opening_days.year = (player_years.year) left join "t01f2c2a7ab158240bb0c9e5bd8b6f248" on "t01f2c2a7ab158240bb0c9e5bd8b6f248"."pid" = "player"."pid" and t01f2c2a7ab158240bb0c9e5bd8b6f248.year = player_years.year and t01f2c2a7ab158240bb0c9e5bd8b6f248.year IN (2020,2021,2022,2023) left join "tdb9449e277dd7acfa7becffc6837de2d" on "tdb9449e277dd7acfa7becffc6837de2d"."pid" = "player"."pid" and tdb9449e277dd7acfa7becffc6837de2d.year = player_years.year and tdb9449e277dd7acfa7becffc6837de2d.year IN (2020,2021,2022,2023) left join "t3be086b09900f234abe240b87af2a599" on "t3be086b09900f234abe240b87af2a599"."pid" = "player"."pid" and t3be086b09900f234abe240b87af2a599.year = player_years.year + 1 left join "t5eab6573d0b9be8987373d4cc8d0e985" on "t5eab6573d0b9be8987373d4cc8d0e985"."pid" = "player"."pid" and t5eab6573d0b9be8987373d4cc8d0e985.year = player_years.year + 1 where player.pos IN ('RB') group by player.fname, player.lname, rosters_players.slot, rosters_players.tid, rosters_players.tag, "t759e866ebe92b4ae46ecd539fdd67a4f"."v", "t01f2c2a7ab158240bb0c9e5bd8b6f248"."weighted_opportunity_from_plays", t586c8b9b6bf4a42a3143b8e2162eabbc.rate_type_total_count, "tdb9449e277dd7acfa7becffc6837de2d"."fantasy_points_from_plays", t586c8b9b6bf4a42a3143b8e2162eabbc.rate_type_total_count, "t3be086b09900f234abe240b87af2a599"."weighted_opportunity_from_plays", t0be753947ae8001f7b12c1e04f585bac.rate_type_total_count, "t5eab6573d0b9be8987373d4cc8d0e985"."fantasy_points_from_plays", t0be753947ae8001f7b12c1e04f585bac.rate_type_total_count, "player_years"."year", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 12 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(twelve_hours)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
  ...
  it('year splits with a column set to a specific year', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "tbe52d66012ecd685e62b3220886e035e" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) group by "nfl_games"."year", "player_gamelogs"."pid"), "tb972f2cc9e2375df01dce515be38a32b" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2023) group by "nfl_games"."year", "player_gamelogs"."pid"), "t3762290b3986a2c351f7809c57464ffb" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(epa) AS team_ep_added_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) and "nfl_plays"."wp" between 0.2 and 0.8 group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t3762290b3986a2c351f7809c57464ffb_team_stats" as (select "t3762290b3986a2c351f7809c57464ffb"."nfl_team", sum(t3762290b3986a2c351f7809c57464ffb.team_ep_added_from_plays) as team_ep_added_from_plays, "t3762290b3986a2c351f7809c57464ffb"."year" from "t3762290b3986a2c351f7809c57464ffb" where "t3762290b3986a2c351f7809c57464ffb"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) group by "t3762290b3986a2c351f7809c57464ffb"."nfl_team", "t3762290b3986a2c351f7809c57464ffb"."year"), "t9e00babf8d933d25f1f2ebb2a1f74877" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(epa) AS team_ep_added_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) and "nfl_plays"."wp" between 0.2 and 0.8 group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t9e00babf8d933d25f1f2ebb2a1f74877_team_stats" as (select "t9e00babf8d933d25f1f2ebb2a1f74877"."nfl_team", sum(t9e00babf8d933d25f1f2ebb2a1f74877.team_ep_added_from_plays) as team_ep_added_from_plays, "t9e00babf8d933d25f1f2ebb2a1f74877"."year" from "t9e00babf8d933d25f1f2ebb2a1f74877" where "t9e00babf8d933d25f1f2ebb2a1f74877"."year" in (2023) group by "t9e00babf8d933d25f1f2ebb2a1f74877"."nfl_team", "t9e00babf8d933d25f1f2ebb2a1f74877"."year") select "player"."pid", player.fname, player.lname, CAST(t3762290b3986a2c351f7809c57464ffb_team_stats.team_ep_added_from_plays AS DECIMAL) / NULLIF(CAST(tbe52d66012ecd685e62b3220886e035e.rate_type_total_count AS DECIMAL), 0) AS "team_ep_added_from_plays_0", CAST(t9e00babf8d933d25f1f2ebb2a1f74877_team_stats.team_ep_added_from_plays AS DECIMAL) / NULLIF(CAST(tb972f2cc9e2375df01dce515be38a32b.rate_type_total_count AS DECIMAL), 0) AS "team_ep_added_from_plays_1", "player_years"."year", "player"."pos" from "player_years" inner join "player" on "player"."pid" = "player_years"."pid" left join "tbe52d66012ecd685e62b3220886e035e" on "tbe52d66012ecd685e62b3220886e035e"."pid" = "player"."pid" and "tbe52d66012ecd685e62b3220886e035e"."year" = "player_years"."year" left join "tb972f2cc9e2375df01dce515be38a32b" on "tb972f2cc9e2375df01dce515be38a32b"."pid" = "player"."pid" and "tb972f2cc9e2375df01dce515be38a32b"."year" = 2023 left join "t3762290b3986a2c351f7809c57464ffb_team_stats" on "t3762290b3986a2c351f7809c57464ffb_team_stats"."nfl_team" = "player"."current_nfl_team" and t3762290b3986a2c351f7809c57464ffb_team_stats.year = player_years.year and t3762290b3986a2c351f7809c57464ffb_team_stats.year IN (2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023) left join "t9e00babf8d933d25f1f2ebb2a1f74877_team_stats" on "t9e00babf8d933d25f1f2ebb2a1f74877_team_stats"."nfl_team" = "player"."current_nfl_team" and "t9e00babf8d933d25f1f2ebb2a1f74877_team_stats"."year" = 2023 where player.pos IN ('DST') group by player.fname, player.lname, "t3762290b3986a2c351f7809c57464ffb_team_stats"."team_ep_added_from_plays", tbe52d66012ecd685e62b3220886e035e.rate_type_total_count, "t9e00babf8d933d25f1f2ebb2a1f74877_team_stats"."team_ep_added_from_plays", tb972f2cc9e2375df01dce515be38a32b.rate_type_total_count, "player_years"."year", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
  ...
  it('team success rate from plays', () => {
    ...
    const expected_query = `with "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(CASE WHEN successful_play = true THEN 1 ELSE 0 END) as team_success_rate_from_plays_numerator, COUNT(*) as team_success_rate_from_plays_denominator from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_success_rate_from_plays_numerator) / sum(t637d41a7043612873a6e482c3ffa3223.team_success_rate_from_plays_denominator) as team_success_rate_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team" having sum(t637d41a7043612873a6e482c3ffa3223.team_success_rate_from_plays_numerator) / NULLIF(sum(t637d41a7043612873a6e482c3ffa3223.team_success_rate_from_plays_denominator), 0) > '0.4') select "player"."pid", "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_success_rate_from_plays" AS "team_success_rate_from_plays_0", "player"."pos" from "player" inner join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_success_rate_from_plays", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(one_week)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
