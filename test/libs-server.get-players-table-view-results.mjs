...
describe('LIBS SERVER get_data_view_results', () => {
  ...
  it('year splits with a column set to a specific year', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "tbe52d66012ecd685e62b3220886e035e" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) group by "nfl_games"."year", "player_gamelogs"."pid"), "tb972f2cc9e2375df01dce515be38a32b" as (select "player_gamelogs"."pid", count(*) as "rate_type_total_count", "nfl_games"."year" from "player_gamelogs" left join "nfl_games" on "nfl_games"."esbid" = "player_gamelogs"."esbid" where "nfl_games"."seas_type" = 'REG' and "player_gamelogs"."active" = true and "nfl_games"."year" in (2023) group by "nfl_games"."year", "player_gamelogs"."pid"), "t3762290b3986a2c351f7809c57464ffb" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(epa) AS team_ep_added_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) and "nfl_plays"."wp" between 0.2 and 0.8 group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t3762290b3986a2c351f7809c57464ffb_player_team_stats" as (select "player_gamelogs"."pid", sum(t3762290b3986a2c351f7809c57464ffb.team_ep_added_from_plays) as team_ep_added_from_plays, "nfl_games"."year" from "player_gamelogs" inner join "nfl_games" on "player_gamelogs"."esbid" = "nfl_games"."esbid" inner join "t3762290b3986a2c351f7809c57464ffb" on "player_gamelogs"."tm" = "t3762290b3986a2c351f7809c57464ffb"."nfl_team" and "nfl_games"."year" = "t3762290b3986a2c351f7809c57464ffb"."year" and "nfl_games"."week" = "t3762290b3986a2c351f7809c57464ffb"."week" where "nfl_games"."seas_type" = 'REG' and "nfl_games"."year" in (2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023) group by "player_gamelogs"."pid", "nfl_games"."year"), "t9e00babf8d933d25f1f2ebb2a1f74877" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(epa) AS team_ep_added_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) and "nfl_plays"."wp" between 0.2 and 0.8 group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats" as (select "player_gamelogs"."pid", sum(t9e00babf8d933d25f1f2ebb2a1f74877.team_ep_added_from_plays) as team_ep_added_from_plays, "nfl_games"."year" from "player_gamelogs" inner join "nfl_games" on "player_gamelogs"."esbid" = "nfl_games"."esbid" inner join "t9e00babf8d933d25f1f2ebb2a1f74877" on "player_gamelogs"."tm" = "t9e00babf8d933d25f1f2ebb2a1f74877"."nfl_team" and "nfl_games"."year" = "t9e00babf8d933d25f1f2ebb2a1f74877"."year" and "nfl_games"."week" = "t9e00babf8d933d25f1f2ebb2a1f74877"."week" where "nfl_games"."seas_type" = 'REG' and "nfl_games"."year" in (2023) group by "player_gamelogs"."pid", "nfl_games"."year") select "player"."pid", player.fname, player.lname, CAST(t3762290b3986a2c351f7809c57464ffb_player_team_stats.team_ep_added_from_plays AS DECIMAL) / NULLIF(CAST(tbe52d66012ecd685e62b3220886e035e.rate_type_total_count AS DECIMAL), 0) AS "team_ep_added_from_plays_0", CAST(t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats.team_ep_added_from_plays AS DECIMAL) / NULLIF(CAST(tb972f2cc9e2375df01dce515be38a32b.rate_type_total_count AS DECIMAL), 0) AS "team_ep_added_from_plays_1", "player_years"."year", "player"."pos" from "player_years" inner join "player" on "player"."pid" = "player_years"."pid" left join "tbe52d66012ecd685e62b3220886e035e" on "tbe52d66012ecd685e62b3220886e035e"."pid" = "player"."pid" and "tbe52d66012ecd685e62b3220886e035e"."year" = "player_years"."year" left join "tb972f2cc9e2375df01dce515be38a32b" on "tb972f2cc9e2375df01dce515be38a32b"."pid" = "player"."pid" and "tb972f2cc9e2375df01dce515be38a32b"."year" = 2023 left join "t3762290b3986a2c351f7809c57464ffb_player_team_stats" on "t3762290b3986a2c351f7809c57464ffb_player_team_stats"."pid" = "player"."pid" and t3762290b3986a2c351f7809c57464ffb_player_team_stats.year = player_years.year and t3762290b3986a2c351f7809c57464ffb_player_team_stats.year IN (2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023) left join "t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats" on "t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats"."pid" = "player"."pid" and "t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats"."year" = 2023 where player.pos IN ('DST') group by player.fname, player.lname, "t3762290b3986a2c351f7809c57464ffb_player_team_stats"."team_ep_added_from_plays", tbe52d66012ecd685e62b3220886e035e.rate_type_total_count, "t9e00babf8d933d25f1f2ebb2a1f74877_player_team_stats"."team_ep_added_from_plays", tb972f2cc9e2375df01dce515be38a32b.rate_type_total_count, "player_years"."year", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
