...
describe('LIBS SERVER get_data_view_results', () => {
  ...
  it('should create a rushing yards split by week', () => {
    ...
    const expected_query = `with "base_years" as (SELECT unnest(ARRAY[2020,2021,2022,2023]) as year), "player_years" as (SELECT DISTINCT player.pid, base_years.year FROM player CROSS JOIN base_years), "player_years_weeks" as (SELECT player_years.pid, nfl_year_week_timestamp.year, nfl_year_week_timestamp.week FROM player_years INNER JOIN nfl_year_week_timestamp ON player_years.year = nfl_year_week_timestamp.year), "t486f8f57169149f12149f53528ff5208" as (select COALESCE(bc_pid) as pid, "nfl_plays"."week", "nfl_plays"."year", SUM(rush_yds) as rush_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023) group by "nfl_plays"."week", "nfl_plays"."year", COALESCE(bc_pid)), "t59d3bc6671183e938be8bcc0abb76588" as (select "nfl_plays"."off" as "nfl_team", SUM(rush_yds) AS team_rush_yds_from_plays, "nfl_plays"."year", "nfl_plays"."week" from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2020, 2021, 2022, 2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t59d3bc6671183e938be8bcc0abb76588_team_stats" as (select "t59d3bc6671183e938be8bcc0abb76588"."nfl_team", sum(t59d3bc6671183e938be8bcc0abb76588.team_rush_yds_from_plays) as team_rush_yds_from_plays, "t59d3bc6671183e938be8bcc0abb76588"."year", "t59d3bc6671183e938be8bcc0abb76588"."week" from "t59d3bc6671183e938be8bcc0abb76588" group by "t59d3bc6671183e938be8bcc0abb76588"."nfl_team", "t59d3bc6671183e938be8bcc0abb76588"."year", "t59d3bc6671183e938be8bcc0abb76588"."week") select "player"."pid", player.fname, player.lname, "t486f8f57169149f12149f53528ff5208"."rush_yds_from_plays" AS "rush_yds_from_plays_0", "tf0b1e8f00d3f5ec618c9b50a239c6c22"."ry" AS "week_projected_rush_yds_0", "t59d3bc6671183e938be8bcc0abb76588_team_stats"."team_rush_yds_from_plays" AS "team_rush_yds_from_plays_0", "player_years"."year", COALESCE(t486f8f57169149f12149f53528ff5208.week, tf0b1e8f00d3f5ec618c9b50a239c6c22.week, t59d3bc6671183e938be8bcc0abb76588_team_stats.week) AS week, "player"."pos" from "player_years_weeks" inner join "player" on "player"."pid" = "player_years_weeks"."pid" inner join "player_years" on "player_years"."pid" = "player"."pid" and "player_years"."year" = "player_years_weeks"."year" left join "t486f8f57169149f12149f53528ff5208" on "t486f8f57169149f12149f53528ff5208"."pid" = "player"."pid" and t486f8f57169149f12149f53528ff5208.year = player_years_weeks.year and t486f8f57169149f12149f53528ff5208.year IN (2020,2021,2022,2023) and t486f8f57169149f12149f53528ff5208.week = player_years_weeks.week left join "projections_index" as "tf0b1e8f00d3f5ec618c9b50a239c6c22" on "tf0b1e8f00d3f5ec618c9b50a239c6c22"."pid" = "player"."pid" and tf0b1e8f00d3f5ec618c9b50a239c6c22.year = player_years_weeks.year and tf0b1e8f00d3f5ec618c9b50a239c6c22.year IN (2020,2021,2022,2023) and tf0b1e8f00d3f5ec618c9b50a239c6c22.week = player_years_weeks.week and "tf0b1e8f00d3f5ec618c9b50a239c6c22"."sourceid" = 18 left join "t59d3bc6671183e938be8bcc0abb76588_team_stats" on "t59d3bc6671183e938be8bcc0abb76588_team_stats"."nfl_team" = "player"."current_nfl_team" and t59d3bc6671183e938be8bcc0abb76588_team_stats.year = player_years_weeks.year and t59d3bc6671183e938be8bcc0abb76588_team_stats.year IN (2020,2021,2022,2023) and t59d3bc6671183e938be8bcc0abb76588_team_stats.week = player_years_weeks.week group by player.fname, player.lname, "t486f8f57169149f12149f53528ff5208"."rush_yds_from_plays", "tf0b1e8f00d3f5ec618c9b50a239c6c22"."ry", "t59d3bc6671183e938be8bcc0abb76588_team_stats"."team_rush_yds_from_plays", "player_years"."year", COALESCE(t486f8f57169149f12149f53528ff5208.week, tf0b1e8f00d3f5ec618c9b50a239c6c22.week, t59d3bc6671183e938be8bcc0abb76588_team_stats.week), "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 4 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
    expect(data_view_metadata.cache_ttl).to.equal(one_week)
    expect(data_view_metadata.cache_expire_at).to.equal(null)
  })
