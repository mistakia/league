...
describe('LIBS SERVER get_data_view_results', () => {
  ...
  it('player_salaries with where', () => {
    ...
    const expected_query = `with "tfdc85d6d1e23cd26bfb9b1ea27ad3e87" as (select "player_salaries"."pid", "player_salaries"."salary", "nfl_games"."year", "nfl_games"."week" from "player_salaries" inner join "nfl_games" on "player_salaries"."esbid" = "nfl_games"."esbid" where "player_salaries"."source_id" = 'DRAFTKINGS' and "nfl_games"."year" in (2024) and "nfl_games"."week" in (1) and player_salaries.salary >= '5000') select "player"."pid", "tfdc85d6d1e23cd26bfb9b1ea27ad3e87"."salary" AS "dfs_salary_0", "player"."pos" from "player" inner join "tfdc85d6d1e23cd26bfb9b1ea27ad3e87" on "tfdc85d6d1e23cd26bfb9b1ea27ad3e87"."pid" = "player"."pid" group by "tfdc85d6d1e23cd26bfb9b1ea27ad3e87"."salary", "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })
