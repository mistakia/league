...
describe('LIBS SERVER get_data_view_results', () => {
  ...
  it('team stat with per_team_play', () => {
    const { query } = get_data_view_results_query({
      columns: [
        {
  ...
  it('team stat with per_team_pass_play', () => {
    ...
    const expected_query = `with "tbe3a8937e6fc508a70ddc55ef6635b58" as (select "nfl_plays"."off", COUNT(*) as rate_type_total_count from "nfl_plays" where "nfl_plays"."seas_type" = 'REG' and not "play_type" = 'NOPL' and "play_type" = 'PASS' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off"), "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(pass_yds) AS team_pass_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_pass_yds_from_plays) as team_pass_yds_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", CAST(t637d41a7043612873a6e482c3ffa3223_team_stats.team_pass_yds_from_plays AS DECIMAL) / NULLIF(CAST(tbe3a8937e6fc508a70ddc55ef6635b58.rate_type_total_count AS DECIMAL), 0) AS "team_pass_yds_from_plays_0", "player"."pos" from "player" left join "tbe3a8937e6fc508a70ddc55ef6635b58" on "tbe3a8937e6fc508a70ddc55ef6635b58"."off" = "player"."current_nfl_team" left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_yds_from_plays", tbe3a8937e6fc508a70ddc55ef6635b58.rate_type_total_count, "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })

  it('team stat with per_team_rush_play', () => {
    const { query } = get_data_view_results_query({
      columns: [
        {
    ...
    const expected_query = `with "t251a33628b0ba377c8337eba7cf7a945" as (select "nfl_plays"."off", COUNT(*) as rate_type_total_count from "nfl_plays" where "nfl_plays"."seas_type" = 'REG' and not "play_type" = 'NOPL' and "play_type" = 'RUSH' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off"), "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(rush_yds) AS team_rush_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_rush_yds_from_plays) as team_rush_yds_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", CAST(t637d41a7043612873a6e482c3ffa3223_team_stats.team_rush_yds_from_plays AS DECIMAL) / NULLIF(CAST(t251a33628b0ba377c8337eba7cf7a945.rate_type_total_count AS DECIMAL), 0) AS "team_rush_yds_from_plays_0", "player"."pos" from "player" left join "t251a33628b0ba377c8337eba7cf7a945" on "t251a33628b0ba377c8337eba7cf7a945"."off" = "player"."current_nfl_team" left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_rush_yds_from_plays", t251a33628b0ba377c8337eba7cf7a945.rate_type_total_count, "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })
  ...
  it('team stat with per_team_quarter', () => {
    ...
    const expected_query = `with "td7a049717e19b49281d2b5a0bc754848" as (select "nfl_plays"."off", COUNT(DISTINCT CONCAT(nfl_plays.esbid, qtr)) as rate_type_total_count from "nfl_plays" where "nfl_plays"."seas_type" = 'REG' and not "play_type" = 'NOPL' and "play_type" in ('PASS', 'RUSH') and "nfl_plays"."year" in (2023) group by "nfl_plays"."off"), "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(pass_yds) AS team_pass_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_pass_yds_from_plays) as team_pass_yds_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", CAST(t637d41a7043612873a6e482c3ffa3223_team_stats.team_pass_yds_from_plays AS DECIMAL) / NULLIF(CAST(td7a049717e19b49281d2b5a0bc754848.rate_type_total_count AS DECIMAL), 0) AS "team_pass_yds_from_plays_0", "player"."pos" from "player" left join "td7a049717e19b49281d2b5a0bc754848" on "td7a049717e19b49281d2b5a0bc754848"."off" = "player"."current_nfl_team" left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_yds_from_plays", td7a049717e19b49281d2b5a0bc754848.rate_type_total_count, "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })

  it('team stat with per_team_drive', () => {
    const { query } = get_data_view_results_query({
      columns: [
        {
          column_id: 'team_pass_yards_from_plays',
    ...
    const expected_query = `with "tde9b5fd8ea05f00778fb8a6b9fab5456" as (select "nfl_plays"."off", COUNT(DISTINCT CONCAT(nfl_plays.esbid, drive_seq)) as rate_type_total_count from "nfl_plays" where "nfl_plays"."seas_type" = 'REG' and not "play_type" = 'NOPL' and "play_type" in ('PASS', 'RUSH') and "nfl_plays"."year" in (2023) group by "nfl_plays"."off"), "t637d41a7043612873a6e482c3ffa3223" as (select "nfl_plays"."off" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(pass_yds) AS team_pass_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (2023) group by "nfl_plays"."off", "nfl_plays"."year", "nfl_plays"."week"), "t637d41a7043612873a6e482c3ffa3223_team_stats" as (select "t637d41a7043612873a6e482c3ffa3223"."nfl_team", sum(t637d41a7043612873a6e482c3ffa3223.team_pass_yds_from_plays) as team_pass_yds_from_plays from "t637d41a7043612873a6e482c3ffa3223" where "t637d41a7043612873a6e482c3ffa3223"."year" in (2023) group by "t637d41a7043612873a6e482c3ffa3223"."nfl_team") select "player"."pid", CAST(t637d41a7043612873a6e482c3ffa3223_team_stats.team_pass_yds_from_plays AS DECIMAL) / NULLIF(CAST(tde9b5fd8ea05f00778fb8a6b9fab5456.rate_type_total_count AS DECIMAL), 0) AS "team_pass_yds_from_plays_0", "player"."pos" from "player" left join "tde9b5fd8ea05f00778fb8a6b9fab5456" on "tde9b5fd8ea05f00778fb8a6b9fab5456"."off" = "player"."current_nfl_team" left join "t637d41a7043612873a6e482c3ffa3223_team_stats" on "t637d41a7043612873a6e482c3ffa3223_team_stats"."nfl_team" = "player"."current_nfl_team" group by "t637d41a7043612873a6e482c3ffa3223_team_stats"."team_pass_yds_from_plays", tde9b5fd8ea05f00778fb8a6b9fab5456.rate_type_total_count, "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 2 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })

  it('team stat with per_team_series', () => {
    const { query } = get_data_view_results_query({
      columns: [
        {
          column_id: 'team_pass_yards_from_plays',
  ...
  it('team field with matchup_opponent_type param', () => {
    ...
    const expected_query = `with "current_week_opponents" as (select "h" as "nfl_team", "v" as "opponent" from "public"."nfl_games" where "year" = ${constants.season.year} and "week" = ${constants.season.week} and "seas_type" = 'REG' union select "v" as "nfl_team", "h" as "opponent" from "public"."nfl_games" where "year" = ${constants.season.year} and "week" = ${constants.season.week} and "seas_type" = 'REG'), "tc65066722edb035b5364db8e1f1bedc9" as (select "nfl_plays"."off" as "team", count(distinct "nfl_plays"."esbid") as "rate_type_total_count" from "nfl_plays" where "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (${constants.season.year}) group by "nfl_plays"."off"), "tffdb105f699842b52e7d4f3bc0fe127a" as (select "year", "week", v as nfl_team, h as game_opponent, true as game_is_home from "nfl_games" where "year" in (${constants.season.year}) and "week" in (${constants.season.week}) and "seas_type" = 'REG' and h IN ('WAS', 'ARI', 'LAR') union select "year", "week", h as nfl_team, v as game_opponent, false as game_is_home from "nfl_games" where "year" in (${constants.season.year}) and "week" in (${constants.season.week}) and "seas_type" = 'REG' and v IN ('WAS', 'ARI', 'LAR')), "t2499920d348f58d2e046bda75243c5e0" as (select "nfl_plays"."def" as "nfl_team", "nfl_plays"."year", "nfl_plays"."week", SUM(pass_yds) AS team_pass_yds_from_plays from "nfl_plays" where not "play_type" = 'NOPL' and "nfl_plays"."seas_type" = 'REG' and "nfl_plays"."year" in (${constants.season.year}) group by "nfl_plays"."def", "nfl_plays"."year", "nfl_plays"."week"), "t2499920d348f58d2e046bda75243c5e0_team_stats" as (select "t2499920d348f58d2e046bda75243c5e0"."nfl_team", sum(t2499920d348f58d2e046bda75243c5e0.team_pass_yds_from_plays) as team_pass_yds_from_plays from "t2499920d348f58d2e046bda75243c5e0" where "t2499920d348f58d2e046bda75243c5e0"."year" in (${constants.season.year}) group by "t2499920d348f58d2e046bda75243c5e0"."nfl_team") select "player"."pid", player.fname, player.lname, "player"."pos" AS "pos_0", CAST(t2499920d348f58d2e046bda75243c5e0_team_stats.team_pass_yds_from_plays AS DECIMAL) / NULLIF(CAST(tc65066722edb035b5364db8e1f1bedc9.rate_type_total_count AS DECIMAL), 0) AS "team_pass_yds_from_plays_0", "player"."pos" from "player" inner join "current_week_opponents" on "player"."current_nfl_team" = "current_week_opponents"."nfl_team" left join "tc65066722edb035b5364db8e1f1bedc9" on "tc65066722edb035b5364db8e1f1bedc9"."team" = "current_week_opponents"."opponent" inner join "tffdb105f699842b52e7d4f3bc0fe127a" on "tffdb105f699842b52e7d4f3bc0fe127a"."nfl_team" = "player"."current_nfl_team" left join "t2499920d348f58d2e046bda75243c5e0_team_stats" on "t2499920d348f58d2e046bda75243c5e0_team_stats"."nfl_team" = "current_week_opponents"."opponent" group by player.fname, player.lname, "player"."pos", "t2499920d348f58d2e046bda75243c5e0_team_stats"."team_pass_yds_from_plays", tc65066722edb035b5364db8e1f1bedc9.rate_type_total_count, "player"."pid", "player"."lname", "player"."fname", "player"."pos" order by 5 DESC NULLS LAST, "player"."pid" asc limit 500`
    compare_queries(query.toString(), expected_query)
  })
