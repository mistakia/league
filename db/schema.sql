...
CREATE TABLE `player` (
  ...
  `mfl_id` int(11) DEFAULT NULL,
  `fantasypros_id` int(11) DEFAULT NULL,
  `pff_id` int(11) DEFAULT NULL,
  `fleaflicker_id` int(11) DEFAULT NULL,
  `cbs_id` int(11) DEFAULT NULL,
  `cfbref_id` varchar(100) DEFAULT NULL,
  `statsperform_id` int(11) DEFAULT NULL,
  `statsperform_global_id` int(11) DEFAULT NULL,
  `swish_id` int(11) DEFAULT NULL,
  ...
  UNIQUE KEY `mfl_id` (`mfl_id`),
  UNIQUE KEY `fantasypros_id` (`fantasypros_id`),
  UNIQUE KEY `pff_id` (`pff_id`),
  UNIQUE KEY `fleaflicker_id` (`fleaflicker_id`),
  UNIQUE KEY `cbs_id` (`cbs_id`),
  UNIQUE KEY `cfbref_id` (`cfbref_id`),
  UNIQUE KEY `statsperform_id` (`statsperform_id`),
  UNIQUE KEY `statsperform_global_id` (`statsperform_global_id`),
  UNIQUE KEY `swish_id` (`swish_id`),
  UNIQUE KEY `pid` (`pid`),
  KEY `fname` (`fname`),
  KEY `lname` (`lname`)
