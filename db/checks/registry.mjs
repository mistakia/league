...
const registry = [
...

  {
    ...
    min_rate: 1.0,
    calibration:
      'EXACT, not a tolerance: a FINAL game either has snap rows or it does not. Measured 2026-08-26 across 208 gradeable weeks from 2016 (259 in range before the eight-game precondition): fifth percentile 1.0000, and only FOUR weeks short of full coverage. Two are the live defect this was written for — 2026 PRE week 2 at 0.0000, all sixteen games, and 2026 PRE week 1 at 0.6875, eleven of sixteen — caused by a DEAD NFL Pro credential rather than anything about those weeks: import-plays-nfl-pro last succeeded 2026-08-15 and has failed at login with NEEDS_OPERATOR_LOGIN on every run since 2026-08-16, one day after its preseason schedule was created. That went unread for eleven days because both NFL Pro importers ended main() with a bare process.exit(), so the scheduled-command ledger recorded seven consecutive SUCCESSES over a credential that was importing nothing. The other two are single stranded games, 2016 PRE week 4 and 2021 PRE week 3, both at 0.9375. The 2016 floor is where nfl_snaps coverage begins; grading earlier would report a decade of absence that no repair can clear. Every one of the four is PRESEASON, which is the season_type every scheduled path treats as optional.',
    min_gradeable_units: 150,
    repair_command:
