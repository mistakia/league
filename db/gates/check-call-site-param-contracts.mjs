...
// The import edge IS the anchor, and it is shared with
// check-returned-property-reads rather than copied into it -- a design choice
// held in two places is one weakening away from a decoy control that still
// passes. Path depth is load-bearing and lives with `repo_root` there.
import {
  repo_root,
  walk_ast,
  parse_module,
...
export { resolve_specifier, collect_import_bindings, resolve_exported_function }
